...
LDLIBS =
PROGRAM = ez3fs
SOURCES = ez3fs.cpp src/ez3fs_archive.cpp src/ez3fs_archive_loader.cpp src/ez3fs_new_image_file.cpp src/ez3fs_virtual_filesystem.cpp src/ez3fs_fuse_mount.cpp src/ez3fs_cartridge_storage.cpp
...
all: $(PROGRAM)
$(PROGRAM): $(SOURCES) include/ez3fs/archive.hpp include/ez3fs/virtual_filesystem.hpp include/ez3fs/fuse_mount.hpp include/ez3fs/cartridge_storage.hpp include/ez3fs/cartridge_programmer.hpp include/ez3fs/timestamp.hpp include/ez3fs/version.hpp
...
clean:
	rm -f $(PROGRAM) build/ez3fs_archive_test build/ez3fs_virtual_filesystem_test build/ez3fs_new_image_file_test
