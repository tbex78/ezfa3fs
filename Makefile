...
LDLIBS =
PROGRAM = ez3fs
SOURCES = ez3fs.cpp src/ez3fs_archive.cpp src/ez3fs_archive_loader.cpp src/ez3fs_virtual_filesystem.cpp src/ez3fs_fuse_mount.cpp src/ez3fs_cartridge_storage.cpp
