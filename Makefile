...
LDLIBS =
PROGRAM = ez3fs
SOURCES = ez3fs.cpp src/ez3fs_archive.cpp src/ez3fs_archive_comparison.cpp src/ez3fs_archive_loader.cpp src/ez3fs_new_image_file.cpp src/ez3fs_recovery_snapshot.cpp src/ez3fs_virtual_filesystem.cpp src/ez3fs_fuse_mount.cpp src/ez3fs_cartridge_storage.cpp
...
test:
	...
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) $(WARNFLAGS) tests/ez3fs_recovery_snapshot_test.cpp src/ez3fs_archive.cpp src/ez3fs_new_image_file.cpp src/ez3fs_recovery_snapshot.cpp -o build/ez3fs_recovery_snapshot_test
	./build/ez3fs_recovery_snapshot_test

clean:
	rm -f $(PROGRAM) build/ez3fs_archive_test build/ez3fs_virtual_filesystem_test build/ez3fs_new_image_file_test build/ez3fs_archive_comparison_test build/ez3fs_recovery_snapshot_test
