...
This document describes the packed `.ez3fs` format retained by `ezfs-legacy`. Application version **0.45.12** reads format minors 0 through 2 and writes format **1.2**.
