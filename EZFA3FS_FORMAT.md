...
This document describes the 32 MiB EZFA3FS format implemented by application version **0.45.12**. The standard layout is format **2.0.0**; the slotted direct-boot layout is **2.1.0**.
