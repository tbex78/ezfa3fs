...
This document describes the 32 MiB EZFA3FS format implemented by application version **0.50.3**. The standard layout is experimental format **0.1.0**; the slotted direct-boot layout is experimental format **0.2.0**.
